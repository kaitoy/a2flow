 ...
 * status dot; task templates carry no status, so the dot row is omitted. Left
 * and right handles connect dependency edges (prerequisites flow in from the
 * left, dependents flow out of the right).
 *
