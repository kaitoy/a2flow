 ...
 * the same way. The whole "Workflow status" bar is hidden for such a viewer
 * too — a `requester` only ever deals with `published` workflows, so the
 * status would carry no information, and the bar's only other content is
 * those same developer-only actions.
 */
