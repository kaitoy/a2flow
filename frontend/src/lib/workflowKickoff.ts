...
/**
 * Auto-sent as the first chat message of a fresh WorkflowExecution. The tasks were
 * designed and published in advance (the session's tasks are copies of the
