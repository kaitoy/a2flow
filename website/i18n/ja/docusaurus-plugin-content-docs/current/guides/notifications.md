...
![ワークフローの出来事が、関係する 1 人(承認者グループなら資格のある全員)に届き、ベル、通知ページ、そして有効ならメールへ広がることを示すフローチャート。](./img/notifications-routing.svg#gh-light-mode-only)
![ワークフローの出来事が、関係する 1 人(承認者グループなら資格のある全員)に届き、ベル、通知ページ、そして有効ならメールへ広がることを示すフローチャート。](./img/notifications-routing-dark.svg#gh-dark-mode-only)
...
- **速度を抑える。** レート制限がリレーへの送信を毎秒一定の通数に保ち、1 バッチは 1 本の接続を使い回して送られます。
